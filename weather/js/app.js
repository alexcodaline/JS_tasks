...
function showWeather() {
  document.getElementById("temp").textContent = `Temp: ${weatherStation.temp !== null ? weatherStation.temp + '°C' : 'N/A'}`;
  document.getElementById("humidity").textContent = `Humidity: ${weatherStation.humidity !== null ? weatherStation.humidity + '%' : 'N/A'}`;
  document.getElementById("pressure").textContent = `Pressure: ${weatherStation.pressure !== null ? weatherStation.pressure + 'mm' : 'N/A'}`;
  document.getElementById("forecast").textContent = `Weather forecast: ${weatherStation.displayWeatherForecast()}`;
}
...
function updateWeatherDataFromInput() {
  ...
  const pressureInput = parseInt(document.getElementById("pressureInput").value);
  ...
  if (!isNaN(tempInput) && !isNaN(humidityInput) && !isNaN(pressureInput)) {
    ...
    showWeather();
    console.log("Weather data updated:", { temp: tempInput, humidity: humidityInput, pressure: pressureInput });
